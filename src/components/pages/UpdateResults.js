        ...
        <div>
            ...
            <Grid  component="main"
                ...
                <Grid container sx={{display:"flex",
                    mx: 16,width: 1200,mb: 3}}>
                    <Button sx = {{borderRadius: "8px",width:150,mr:24}} onClick={handleComplete} size='large' variant="contained" color='primary'> <ArrowLeftIcon/>Назад</Button>
                    <Button sx = {{borderRadius: "8px",mr:24}} onClick={handlePercent} size='large' variant="contained" color='primary'> Обновить процентное соотношение вопросов </Button>
