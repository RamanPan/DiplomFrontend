...
import {
    API_SET_USER_EMAIL,
    API_SET_USER_FULLNAME,
    API_SET_USER_LOGIN,
    API_SET_USER_PASSWORD,
    API_SET_USER_PICTURE,
...
const UpdateUser = () => {
    ...
    const handleSubmit = async () => {
        ...
        console.log(login)
        usersStore.needUser(obj.id).then(() => {
                    ...
                    <Grid container sx={{mt: 4, width: 1278}}>
                        {isPicture ? (
                            <label htmlFor="contained-button-file">
                                ...
                                <Button component="span" sx={{
                                    ...
                                    <Avatar sx={{height: 400, width: 400}}
                                            src={"http://localhost:8081/images/users/" + PICTURE_UPDATE}/>
                                </Button>
                            </label>) : (
                            <label htmlFor="contained-button-file">
                                <Input accept="image/*" id="contained-button-file" name="file" onChange={uploadHandler}
                                ...
                                <Button component="span" sx={{
                                    ...
                                    <Avatar sx={{height: 400, width: 400}}
                                            src="http://localhost:8081/images/users/default_avatar.png"/>
                                </Button>
                            </label>)}
                        <Grid container sx={{width: 878}}>
                            <Grid sx={{
                                ...
                                <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2}}>Изменить
                                    логин</Typography>
                                <Grid container sx={{ml: 2}}> <TextField
                                    ...
                                    sx={{width: 650}}
                                /> <Button sx={{ml: 2, borderRadius: "8px"}} onClick={handleLogin} variant="contained"
                                           color='primary'>Изменить</Button></Grid>
                                <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2}}>Изменить
                                    ФИО</Typography>
                                <Grid container sx={{ml: 2}}> <TextField
                                    label="Введите ФИО"
                                    ...
                                    sx={{width: 650}}
                                /> <Button sx={{ml: 2, borderRadius: "8px"}} onClick={handleFullname}
                                           variant="contained" color='primary'>Изменить</Button></Grid>
                                <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2}}>Изменить
                                    Email</Typography>
                                <Grid container sx={{ml: 2}}> <TextField
                                    label="Введите email"
                                    ...
                                    sx={{width: 650}}
                                /> <Button sx={{ml: 2, borderRadius: "8px"}} onClick={handleEmail} variant="contained"
                                           color='primary'>Изменить</Button></Grid>
                                <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2,}}>Изменить
                                    пароль</Typography>
                                <Grid container sx={{ml: 2}}> <TextField
                                    ...
                                    sx={{width: 650}}
                                /> <Button sx={{ml: 2, borderRadius: "8px"}} onClick={handlePassword}
                                           variant="contained" color='primary'>Изменить</Button></Grid>
                            </Grid>
                            <Grid sx={{ml: 6, mt: 1, width: 824, height: 75, borderRadius: "15px"}}>
                                <Button sx={{borderRadius: "8px"}} size='large' onClick={handleSubmit}
                                        variant="contained" color='primary'><Typography>Вернуться</Typography>
                                </Button>
                            </Grid>
                        </Grid>
                    </Grid>
