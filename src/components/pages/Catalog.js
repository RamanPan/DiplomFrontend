                ...
                >
                    ...
                    <Grid container sx={{mt: 3, mb: 2}}>
                        <Box sx={{width: '100%', display: 'flex', alignItems: 'flex-start'}}>
                            <ButtonGroup sx={{borderRadius: "15px", mr: 3.5, height: 56,}} variant="contained"
                            ...
                            <Autocomplete size="medium"
                                          id="combo"
                                          style={{backgroundColor: '#F1DCC9', minWidth: 300, borderRadius: "10px"}}
                                          options={types} value={filter}
                                          color="secondary"
                                          ...
                                          renderInput={(params) => <TextField  {...params}
                                                                               label="Фильтрация по типу теста"/>}
                            />
                        </Box>
                        <div className='break'/>
                        <Grid container sx={{
                            ...
                            {testsStore.tests.map(data => (
                                <TestCard id={data.id} testType={data.testType} picture={data.picture}
