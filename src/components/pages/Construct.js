...
import {API_CREATE_TEST, API_UPLOAD_TEST_PICTURE, deterministicOptions, typesConstruct} from "../utils/constans";
        ...
        <div>
            ...
            <Grid container component="main"
                ...
                >
                    ...
                    <Button variant="contained" onClick={handleSubmit} sx={{borderRadius: "10px", mt: 4}}
                            color="primary" size="large">Далее </Button>
                </Box>
            </Grid>
        </div>
    );
