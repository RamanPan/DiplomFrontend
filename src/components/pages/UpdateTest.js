...
const UpdateTest = () => {
    ...
    const handleSubmit = () => {
        postReq(API_UPDATE_TEST, {
            ...
            questionStore.getQuestions({"id": testsStore.passingTest.id}).then(r => {
            ...
            <Grid container component="main"
                ...
                >
                    ...
                    <Grid container sx = {{mt:4,width: 1200,}}>
                        <Button variant="contained" onClick={handleSubmitEnd} sx = {{borderRadius:"10px"}} color="primary" size="large">Закончить редактирование</Button>
                        <Button variant="contained" onClick={handleSubmit} sx = {{borderRadius:"10px"}} color="primary" size="large">Далее </Button>
