...
const Profile = () => {
        ...
        const changePageToTests = () => {
            testsStore.getTestsByAuthor({"author": NICKNAME}).then(() => {
                navigate("/lk/tests")
            })
        }
                ...
                <Grid component="main"
                    ...
                    >
                        ...
                        <Grid container sx={{width: 1400}}>
                            ...
                            <Grid container sx={{width: 878, mt: 4, ml: 15}}><Grid sx={{
                                ml: 6,
                                width: 410,
                                minHeight: 500,
                                ...
                                <Typography align='left' variant='h5'
                                            sx={{ml: 2, mt: 1, mb: 2}}>{usersStore.me.fullname}</Typography>
                                <Typography align='left' variant='h4'
                                            sx={{color: '#9F4636', ml: 2, mt: 2}}>Email</Typography>
                                <Typography align='left' variant='h5'
                                            sx={{ml: 2, mt: 1, mb: 2}}>{usersStore.me.email}</Typography>
                                <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2,}}>Дата
                                    регистраци</Typography>
                                <Typography align='left' variant='h5' sx={{ml: 2, mt: 1, mb: 2}}>{getDate()}</Typography>
                                <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2,}}>Статус
                                    аккаунта</Typography>
                                <Typography align='left' variant='h5' sx={{ml: 2, mt: 1, mb: 2}}>{getRole()}</Typography>
                            </Grid>
                                <Grid sx={{
                                    ml: 0.5,
                                    width: 410,
                                    ...
                                    <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2}}>Кол-во
                                        прохождений</Typography>
                                    <Typography align='left' variant='h5'
                                                sx={{ml: 2, mt: 1, mb: 2}}>{usersStore.me.countPassed}</Typography>
                                    <Typography align='left' variant='h4' sx={{color: '#9F4636', ml: 2, mt: 2}}>Кол-во
                                        созданных тестов</Typography>
                                    <Typography align='left' variant='h5'
                                                sx={{ml: 2, mt: 1, mb: 2}}>{usersStore.me.countCreated}</Typography>
                                </Grid>
                                <Grid sx={{ml: 6, mt: 1, width: 824, height: 75, borderRadius: "15px"}}>
                                    <Button sx={{borderRadius: "8px"}} component={Link} to='/lk/update' size='large'
                                            variant="contained" color='primary'><Typography>Редактировать
                                        данные</Typography>
                                    </Button>
                                </Grid>
                            </Grid>
