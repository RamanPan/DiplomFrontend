...
const Answer = (props) => {
    ...
    const handleGavel = () => {
        if (!agree) {
            ...
            deleteReq(API_DELETE_ANSWER, id).then(() => {
                setAgree(false)
            })
    ...
    return (
        <div>
            ...
            <Grid container>
                <TextField variant='outlined' align='left' size='small' onChange={updateStatement}
                           label='Введите текст ответа(до 100 символов)'
