            ...
            <Card sx={{
                ...
                <CardContent sx={{alignItems: 'flex-start',}}>
                    ...
                    <Grid container sx={{minHeight: 110}}>
                        ...
                        <Grid container>
                            {props.answer.rightAnswer.map(data => (
                                <Typography sx={{fontSize: 20}} align="left">{"Верный ответ: " + data}</Typography>))}
                        </Grid>
                    </Grid>
                    <Grid container justifyContent="center">
                        {props.answer.correctness ? (<CheckIcon sx={{fontSize: 60, color: "#203a27"}}/>) : (
                            <CloseIcon sx={{fontSize: 60, color: "#490005"}}/>)
