    ...
    return (
        ...
        > <Grid container sx={{ml: 2, mt: 2}}>
                ...
                {isPicture ? (
                        <label>
                            ...
                            <Button component="span" sx={{
                                ...
                                <Box component="img"
                                     sx={{width: 320, height: 300, borderRadius: "15px", objectFit: "cover",}}
            ...
            <Grid sx={{maxWidth: 800, minHeight: 300,}}>
                ...
                <TextField variant='outlined' name="statement" onChange={updateStatement}
                           label='Введите текст вопроса(до 200 символов)'
